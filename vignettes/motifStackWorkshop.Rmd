---
title: "Motif analysis with motifStack and dagLogo"
author: "Jianhong Ou^[Department of Cell Biology, Duke University School of Medicine; Regeneration Next, Durham, NC, USA], Haibo Liu^[Department of Molecular, Cell and Cancer Biology, University of Massachusetts Medical School, Worcester, MA, USA], Lihua Julie Zhu^\\(`r ifelse(knitr::is_html_output(), '2', '\\\\dagger')`\\)^"
...
library(Biostrings)
protein<-read.table(system.file("extdata", "irg.txt",
...
library(Biostrings)
dat <- readAAStringSet(system.file("extdata", "irg.aligned.fa",
                                   package = "motifStackWorkshop"))
